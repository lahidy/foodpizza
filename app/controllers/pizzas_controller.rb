class PizzasController < ApplicationController
  ...
  def votos
    ...
    @pizza.increment!(:votes)
    #muestrar el index del usuarioque autoincrementa al usuario
  ...
  def create
    ...
    respond_to do |format|
      if @pizza.save
        format.html { redirect_to @pizza, notice: 'La Pizza hacido Creada.' }
  ...
  def update
    respond_to do |format|
      if @pizza.update(pizza_params)
        format.html { redirect_to @pizza, notice: 'La Pizza  hacido Modificada.' }
  ...
  private
    ...
    def pizza_params
      params.require(:pizza).permit(:name, :votes, :price, :ingredients)
    end
end
